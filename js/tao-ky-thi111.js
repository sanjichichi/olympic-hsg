...
function layThuMucNganHang(mon) {
    return THU_MUC_NGAN_HANG[String(mon || "").trim()] || "";
}

function chuanHoaFileDe(value) {
    ...
    // Chỉ lấy tên file, tránh nhập nhầm đường dẫn
...
/* =========================================================
   XÁC ĐỊNH NGUỒN MỞ TRANG
   ADMIN hoặc GIÁO VIÊN
========================================================= */

const PARAMS_TAO_KY_THI =
    new URLSearchParams(window.location.search);

const TU_ADMIN =
    PARAMS_TAO_KY_THI.get("from") === "admin";
/* =========================================================
...
function kiemTraDangNhapGV() {
    ...
    // ==========================================
    // ADMIN: không yêu cầu đăng nhập giáo viên
    // ==========================================
    if (TU_ADMIN) {
        return true;
    }
